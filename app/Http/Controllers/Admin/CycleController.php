...
class CycleController extends Controller
{
  ...
  public function create(Request $request)
  {
    ...
    //   $path = $request->file('image')->store('public/image/spot/large');
      $path = self::storeImage('public/image/spot/large', $request->file('image'));
      $spot->image_path = basename($path);
    //   $path = $request->file('image_s')->store('public/image/spot/small');
      $path = self::storeImage('public/image/spot/small', $request->file('image_s'));
  ...
  public function update(Request $request)
  {
      ...
      if($request->hasFile('image')) {
            ...
            self::deleteImage('public/image/spot/large', $spot->image_path);
            // $path = $request->file('image')->store('public/image/spot/large');
            $path = self::storeImage('public/image/spot/large', $request->file('image'));
            $spot->image_path = basename($path);
       }
       ...
       if($request->hasFile('image_s')) {
            ...
            self::deleteImage('public/image/spot/small', $spot->image_path_s);
            // $path = $request->file('image_s')->store('public/image/spot/small');
            $path = self::storeImage('public/image/spot/small', $request->file('image_s'));
            $spot->image_path_s = basename($path);
       }
