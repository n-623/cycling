...
@section('content')
    ...
    <div>
    <img id="top" width="680px" src="{{ Utl::imgPath('top', 'yohaku.jpg')}}">
    
    <img class="top" width="1680px" src="{{ Utl::imgPath('top', 'top01.jpg')}}">
    <div class="box" width="1680px" id="hp">
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <p>まだ走ったことがない人にも</p>
                <p>日光の観光情報やコースの紹介をしたくてこのサイトを作成しました。</p>
                <p>観光スポットもまとめてありますので新たな日光の魅力を発見できる</p>
                <p>きっかけになれればと思います。</p>
                <p>Ride With GPSでルートを作成しております。</p>
                <p>各コース紹介の詳細からルートのダウンロードができます。</p>
                </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
    <img id="about_nkkou" width="680px" src="{{ Utl::imgPath('top', 'yohaku.jpg')}}">
        <div class="col-md-8 mx-auto">
            <div class="container">
                <div class="text-center">
                    <h3 >日光について</h3>
                    <p>日光市は栃木県の北西部に位置し、北は福島県、西には群馬県があります。</p>
                    <p>豊かな自然と、歴史的・文化的遺産、温泉などがあり観光地として有名な街。</p>
                    <p>市街地の標高は約200ｍで山岳部では2000ｍを超える山があり高低差のある地形が特徴です。</p>
                    <p>夏は涼しく、冬は厳しい寒さになりますが、四季折々に違った表情を見せてくれます。</p>
                    <p>世界遺産もある日光は、毎年国内、国外から約1000万人もの観光客が訪れています。</p>
                ...
                <img id="course" width="680px" src="{{ Utl::imgPath('top', 'yohaku.jpg')}}">
                <div class="text-center">
                    <h3 >コース紹介</h3>
                    @php $i = 0; @endphp
                    ...
                    <div class="card-group mx-auto" style="max-width: 800px">
                      　<div class="card">
                        　<img class="card-img-top" height="220px" src="{{ Utl::imgPath('course', $item->image_path) }}">
                      　</div>
                      　<div class="card">
                            <div class="card-body">
                                <div class="text-left">
                    ...
                    <img id="temperature" width="680px" src="{{ Utl::imgPath('top', 'yohaku.jpg')}}">
                    <div class="text-center">
                        <h3>年間の気温</h3>
                        <img class="temperature" src="{{ Utl::imgPath('', '気温.png')}}">
                        ...
                        <p>秋の終わりから春先まで(12月中旬〜4月上旬)には路面凍結の恐れ及び積雪があります。</p>
                        <p>また、中禅寺湖を進んだ先にある金精峠は12月下旬から4月下旬まで冬季通行止めとなっています。</p>
                    </div>


                    <img id="four_seasons" width="680px" src="{{ Utl::imgPath('top', 'yohaku.jpg')}}">
                    <div class="text-center">
                        <h3>日光の四季</h3>
                        <div class="row">
                            <div class="image col-md-3 text-left mt-4">
                                <img width="240px" height="240px" src="{{ Utl::imgPath('top', 'haru.jpg')}}"></a>
                            </div>
                            
                            <div class="text col-md-8">
                                <div class="body mt-3">
                                    <div class="p" style="height: 240px">
                                    <p>春の日光市街の平均気温は9.6℃。奥日光の平均気温は4.8℃。</p>
                            ...
                            <div class="image col-md-3 text-left mt-4">
                                <img width="240px" height="240px" src="{{ Utl::imgPath('top', 'natu.jpg')}}"></a>
                            </div>
                            
                            <div class="text col-md-8">
                                <div class="body mt-3">
                                    <div class="p" style="height: 240px">
                                    <p>夏の日光市街と奥日光共に平均気温は20℃。降水量が多く、湿度も高いです。</p>
                            ...
                            <div class="image col-md-3 text-left mt-4">
                                <img width="240px" height="240px" src="{{ Utl::imgPath('top', 'aki.jpg')}}"></a>
                            </div>
                            
                            <div class="text col-md-8">
                                <div class="body mt-3">
                                    <div class="p" style="height: 240px">
                                    <p>秋の日光市街の平均気温は13℃。奥日光の平均気温は11℃。</P>
                            ...
                            <div class="image col-md-3 text-left mt-4">
                                <img width="240px" height="240px" src="{{ Utl::imgPath('top', 'huyu.jpg')}}"></a>
                            </div>
                            
                            <div class="text col-md-8">
                                <div class="body mt-3">
                                    <div class="p" style="height: 240px">
                                    <p>冬の日光市街の平均気温は2℃。奥日光の平均気温は-2.5℃。</p>
